...
SELECT v.vendor_name, p.product_name, COUNT(c.customer_id) * vi.original_price * 5 AS revenue
...
--Update the "current_quantity" field based on the last quantity from vendor_inventory
